...
class DesCryptoModule : BaseModule() {
    override val id = "vflow.data.des"
    override val metadata = ActionMetadata(
        nameStringRes = R.string.module_vflow_data_des_name,
        descriptionStringRes = R.string.module_vflow_data_des_desc,
        name = "DES 加解密",
        description = "使用 DES 对文本进行加密或解密",
    ...
    override val aiMetadata = AiModuleMetadata(
        ...
        workflowStepDescription = "Encrypt or decrypt text with DES.",
        inputHints = mapOf(
            "key" to "DES key with exactly 8 bytes."
        ),
    ...
    override fun getSummary(context: Context, step: ActionStep): CharSequence {
        ...
        return PillUtil.buildSpannable(context, context.getString(R.string.summary_vflow_data_des_prefix), operationPill, " ", sourcePill)
    }
